...
namespace PrognozCS
{
    public partial class Form1 : Form
    {
        ...
        public void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                //Определение К7 при температуре окружающей среды
                if (t <= -40) { K7 = 0.1; K72 = 1; }
                if ((t < -20) && (t < -20)) { K7 = 0.15; K72 = 1; }
                if (t == -20) { K7 = 0.2; K72 = 1; }
                if ((t > -20) && (t < 0)) { K7 = 0.35; K72 = 1; }
                if (t == 0) { K7 = 0.5; K72 = 1; }
            ...
            if (substance.Text == "Водород цианистый")
            {
                //Определение К7 при температуре окружающей среды
                if (t <= -40) { K7 = 0; K72 = 1; }
                if ((t < -20) && (t < -20)) { K7 = 0; K72 = 1; }
                if (t == -20) { K7 = 0; K72 = 1; }
                if ((t > -20) && (t < 0)) { K7 = 0.2; K72 = 1; }
                if (t == 0) { K7 = 0.4; K72 = 1; }
                if ((t > 0) && (t < 20)) { K7 = 0.7; K72 = 1; }
                if (t == 20) { K7 = 1; K72 = 1; }
                if ((t > 20) && (t < 40)) { K7 = 1.15; K72 = 1; }
                if (t >= 40) { K7 = 1.3; K72 = 1; }
                //Коэффициент К1
                K1 = 0;
            }
            /////////////////////////////////////////////////////////////
            ...
            if (substance.Text == "Сероводород")
            {
                ...
                if (substance.Text == "Соляная кислота (концентр.)")
                {
                    //Определение К7 при температуре окружающей среды
                    if (t <= -40) { K7 = 0; K72 = 1; }
                    if ((t < -20) && (t < -20)) { K7 = 0.05; K72 = 1; }
                    if (t == -20) { K7 = 0.1; K72 = 1; }
                    if ((t > -20) && (t < 0)) { K7 = 0.2; K72 = 1; }
                    if (t == 0) { K7 = 0.3; K72 = 1; }
                    if ((t > 0) && (t < 20)) { K7 = 0.75; K72 = 1; }
                    if (t == 20) { K7 = 1; K72 = 1; }
                    if ((t > 20) && (t < 40)) { K7 = 1.3; K72 = 1; }
                    if (t >= 40) { K7 = 1.6; K72 = 1; }
                    //Коэффициент К1
                    K1 = 0;
                }
                /////////////////////////////////////////////////////////////
